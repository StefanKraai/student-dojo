...
public class GildedRoseTest {
    ...
    public void after_one_day_with_sufuras_having_sellIn_lesser_than_zero_and_quality_greater_than_zero() {
        ...
        items.add(new WeaponItem(new Name("Sulfuras, Hand of Ragnaros"), new SellIn(-1), new Quality(1)));
        repeatUpdateQuality(1);
    ...
    private void repeatUpdateQuality(int times) {
        for (int i = 0; i < times; i++) {
            gildedRose.updateItemsQuality(items);
        }
    }
    ...
    private Item aRandomBackstagePass() {
        ...
        return new PassItem(new Name("Backstage passes to a TAFKAL80ETC concert"), new SellIn(sellIn), new Quality(quality));
    }
}
